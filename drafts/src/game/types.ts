// Draft only. Codex should adapt this into src/game/types.ts.
...
export interface NPCMemory {
  ...
  beliefs: string[];
  doubts: string[];
  attitudes: Partial<Record<NPCId | FactionId | "player", string>>;
  promisesMade: string[];
...
export interface GameEvent {
  ...
  type:
    ...
    | "safety_rejection";
  summary: string;
  actor?: NPCId | "player" | "system" | "world_director";
...
export interface ObservableEvent {
  ...
  observerNpcId: NPCId;
  visibility: "full" | "partial" | "rumor" | "none";
...
export interface MemoryPatchProposal {
  ...
  addDoubts?: string[];
  attitudeUpdates?: Partial<Record<NPCId | FactionId | "player", string>>;
  lastPlayerInteraction?: string;
...
export interface NPCIntentionProposal {
  ...
  intentionType:
    ...
    | "report"
    | "do_nothing";
  target?: NPCId | FactionId | LocationId;
  summary: string;
